...
575003</textarea>
    ...
    ?>
		  ...
		  <tr class="item-row">
		      <td class="item-name"><div class="delete-wpr"><span><?php echo $num++?></span><a class="delete" href="javascript:;" title="Remove row">X</a></div></td>
		...
		<?php }?>
		  ...
		  <tr>
		      ...
		      <td class="total-value"><div id="total">₹<?php echo $amount;?></div></td>
		       </tr>
