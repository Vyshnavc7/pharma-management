...
if (isset($_POST['search'])) {
	...
	$query = "SELECT cus_id as cusid ,med_id as medid, med_name as medname,sale_qty as saleqty FROM cusorder";
					...
					<table class="table table-bordered  table-hover ">
						...
						if ($search_result->num_rows > 0) {
							...
							while ($row = $search_result->fetch_assoc()) {
								...
								echo "<a name='delete' class='button1 del-btn' href=order-del.php?mid=" . $row['medid'] . ">CONFIRM</a>";
								echo "</td>";
								echo "</tr>";
							}
							echo "</table>";
