					...
					<form style="border-radius: 10px;padding: 29px;background-color: #f2f2f2;" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
						<div class="column">
							...
							<p>
								...
								<input style="width: 80%;padding: 7px;border: 3px solid #ccc;border-radius: 4px;" class="form-control" type="number" name="medid" required>
							</p>
							<p>
								<label for="medname">Medicine Name:</label><br>
								<input style="width: 80%;padding: 7px;border: 3px solid #ccc;border-radius: 4px;" class="form-control" type="text" name="medname"required>
							</p>
							<p>
								<label for="qty">Quantity:</label><br>
								<input style="width: 80%;padding: 7px;border: 3px solid #ccc;border-radius: 4px;" class="form-control" type="number" name="qty"required>
							</p>
							<p>
						...
						<div class="column">
							...
							<p>
								...
								<input style="width: 80%;padding: 7px;border: 3px solid #ccc;border-radius: 4px;" class="form-control" type="number" step="0.01" name="sp"required>
							</p>
							<p>
								<label for="loc">Location:</label><br>
								<input style="width: 80%;padding: 7px;border: 3px solid #ccc;border-radius: 4px;" class="form-control" type="text" name="loc"required>
							</p>
						</div>
